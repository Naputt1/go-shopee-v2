...
type ReturnsService interface {
	...
	UploadProof(sid uint64, req UploadProofRequest, tok string) (*UploadProofResponse, error)
	...
	UploadShippingProof(sid uint64, req UploadShippingProofRequest, tok string) (*UploadShippingProofResponse, error)
...
func (s *ReturnsServiceOp) UploadProof(sid uint64, req UploadProofRequest, tok string) (*UploadProofResponse, error) {
...
func (s *ReturnsServiceOp) UploadShippingProof(sid uint64, req UploadShippingProofRequest, tok string) (*UploadShippingProofResponse, error) {
