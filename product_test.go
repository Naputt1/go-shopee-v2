...
func Test_Product_GetCategory(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_category")
		skippedMu.Unlock()
...
func Test_Product_GetAttributeTree(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_attribute_tree")
		skippedMu.Unlock()
...
func Test_Product_GetBrandList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_brand_list")
		skippedMu.Unlock()
...
func Test_Product_GetItemLimit(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_limit")
		skippedMu.Unlock()
...
func Test_Product_GetItemList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_list")
		skippedMu.Unlock()
...
func Test_Product_GetItemBaseInfo(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_base_info")
		skippedMu.Unlock()
...
func Test_Product_GetItemExtraInfo(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_extra_info")
		skippedMu.Unlock()
...
func Test_Product_AddItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.add_item")
		skippedMu.Unlock()
...
func Test_Product_UpdateItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_item")
		skippedMu.Unlock()
...
func Test_Product_DeleteItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.delete_item")
		skippedMu.Unlock()
...
func Test_Product_InitTierVariation(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.init_tier_variation")
		skippedMu.Unlock()
...
func Test_Product_UpdateTierVariation(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_tier_variation")
		skippedMu.Unlock()
...
func Test_Product_GetModelList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_model_list")
		skippedMu.Unlock()
...
func Test_Product_AddModel(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.add_model")
		skippedMu.Unlock()
...
func Test_Product_UpdateModel(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_model")
		skippedMu.Unlock()
...
func Test_Product_DeleteModel(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.delete_model")
		skippedMu.Unlock()
...
func Test_Product_UnlistItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.unlist_item")
		skippedMu.Unlock()
...
func Test_Product_UpdatePrice(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_price")
		skippedMu.Unlock()
...
func Test_Product_UpdateStock(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_stock")
		skippedMu.Unlock()
...
func Test_Product_BoostItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.boost_item")
		skippedMu.Unlock()
...
func Test_Product_GetBoostedList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_boosted_list")
		skippedMu.Unlock()
...
func Test_Product_GetItemPromotion(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_promotion")
		skippedMu.Unlock()
...
func Test_Product_UpdateSipItemPrice(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_sip_item_price")
		skippedMu.Unlock()
...
func Test_Product_SearchItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.search_item")
		skippedMu.Unlock()
...
func Test_Product_GetComment(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_comment")
		skippedMu.Unlock()
...
func Test_Product_ReplyComment(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.reply_comment")
		skippedMu.Unlock()
...
func Test_Product_CategoryRecommend(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.category_recommend")
		skippedMu.Unlock()
...
func Test_Product_RegisterBrand(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.register_brand")
		skippedMu.Unlock()
...
func Test_Product_GetRecommendAttribute(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_recommend_attribute")
		skippedMu.Unlock()
...
func Test_Product_GetWeightRecommendation(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_weight_recommendation")
		skippedMu.Unlock()
...
func Test_Product_GetSizeChartList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_size_chart_list")
		skippedMu.Unlock()
...
func Test_Product_GetSizeChartDetail(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_size_chart_detail")
		skippedMu.Unlock()
...
func Test_Product_GetItemViolationInfo(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_violation_info")
		skippedMu.Unlock()
...
func Test_Product_GetVariations(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_variations")
		skippedMu.Unlock()
...
func Test_Product_GetAllVehicleList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_all_vehicle_list")
		skippedMu.Unlock()
...
func Test_Product_GetVehicleListByCompatibilityDetail(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_vehicle_list_by_compatibility_detail")
		skippedMu.Unlock()
...
func Test_Product_GetItemContentDiagnosisResult(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_content_diagnosis_result")
		skippedMu.Unlock()
...
func Test_Product_GetItemListByContentDiagnosis(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_item_list_by_content_diagnosis")
		skippedMu.Unlock()
...
func Test_Product_GetKitItemLimit(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_kit_item_limit")
		skippedMu.Unlock()
...
func Test_Product_AddKitItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.add_kit_item")
		skippedMu.Unlock()
...
func Test_Product_UpdateKitItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.update_kit_item")
		skippedMu.Unlock()
...
func Test_Product_GetKitItemInfo(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_kit_item_info")
		skippedMu.Unlock()
...
func Test_Product_GetAitemByPitemId(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_aitem_by_pitem_id")
		skippedMu.Unlock()
...
func Test_Product_SearchAttributeValueList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.search_attribute_value_list")
		skippedMu.Unlock()
...
func Test_Product_GetMainItemList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_main_item_list")
		skippedMu.Unlock()
...
func Test_Product_GetDirectItemList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_direct_item_list")
		skippedMu.Unlock()
...
func Test_Product_GetDirectShopRecommendedPrice(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_direct_shop_recommended_price")
		skippedMu.Unlock()
...
func Test_Product_GetProductCertificationRule(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_product_certification_rule")
		skippedMu.Unlock()
...
func Test_Product_PublishItemToOutletShop(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.publish_item_to_outlet_shop")
		skippedMu.Unlock()
...
func Test_Product_GetMartItemMappingById(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_mart_item_mapping_by_id")
		skippedMu.Unlock()
...
func Test_Product_SearchUnpackagedModelList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.search_unpackaged_model_list")
		skippedMu.Unlock()
...
func Test_Product_GenerateKitImage(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.generate_kit_image")
		skippedMu.Unlock()
...
func Test_Product_GetMartItemByOutletItemId(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.product.get_mart_item_by_outlet_item_id")
		skippedMu.Unlock()
