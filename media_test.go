...
func Test_Media_UploadImage(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.upload_image")
		skippedMu.Unlock()
...
func Test_Media_InitVideoUpload(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.init_video_upload")
		skippedMu.Unlock()
...
func Test_Media_UploadVideoPart(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.upload_video_part")
		skippedMu.Unlock()
...
func Test_Media_CompleteVideoUpload(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.complete_video_upload")
		skippedMu.Unlock()
...
func Test_Media_GetVideoUploadResult(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.get_video_upload_result")
		skippedMu.Unlock()
...
func Test_Media_CancelVideoUpload(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.media.cancel_video_upload")
		skippedMu.Unlock()
