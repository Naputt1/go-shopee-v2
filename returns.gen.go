...
// UploadProofFromReader Support sellers to upload evidence, including text and pictures and videos converted into URLs.
// Path: /api/v2/returns/upload_proof
// https://open.shopee.com/documents/v2/v2.returns.upload_proof?module=102&type=1
...
// UploadShippingProofFromReader Use this API to upload shipping proof (Only for TW and BR returns with is_seller_arrange = true). This is not to upload evidence for disputes.
// Path: /api/v2/returns/upload_shipping_proof
// https://open.shopee.com/documents/v2/v2.returns.upload_shipping_proof?module=102&type=1
