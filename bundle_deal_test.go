...
func Test_BundleDeal_AddBundleDeal(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.add_bundle_deal")
		skippedMu.Unlock()
...
func Test_BundleDeal_AddBundleDealItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.add_bundle_deal_item")
		skippedMu.Unlock()
...
func Test_BundleDeal_GetBundleDealList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.get_bundle_deal_list")
		skippedMu.Unlock()
...
func Test_BundleDeal_GetBundleDeal(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.get_bundle_deal")
		skippedMu.Unlock()
...
func Test_BundleDeal_GetBundleDealItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.get_bundle_deal_item")
		skippedMu.Unlock()
...
func Test_BundleDeal_UpdateBundleDeal(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.update_bundle_deal")
		skippedMu.Unlock()
...
func Test_BundleDeal_UpdateBundleDealItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.update_bundle_deal_item")
		skippedMu.Unlock()
...
func Test_BundleDeal_EndBundleDeal(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.end_bundle_deal")
		skippedMu.Unlock()
...
func Test_BundleDeal_DeleteBundleDeal(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.delete_bundle_deal")
		skippedMu.Unlock()
...
func Test_BundleDeal_DeleteBundleDealItem(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.bundle_deal.delete_bundle_deal_item")
		skippedMu.Unlock()
