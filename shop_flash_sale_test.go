...
func Test_ShopFlashSale_GetTimeSlotId(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.get_time_slot_id")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_CreateShopFlashSale(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.create_shop_flash_sale")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_GetItemCriteria(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.get_item_criteria")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_AddShopFlashSaleItems(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.add_shop_flash_sale_items")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_GetShopFlashSaleList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.get_shop_flash_sale_list")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_GetShopFlashSale(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.get_shop_flash_sale")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_GetShopFlashSaleItems(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.get_shop_flash_sale_items")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_UpdateShopFlashSale(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.update_shop_flash_sale")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_UpdateShopFlashSaleItems(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.update_shop_flash_sale_items")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_DeleteShopFlashSale(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.delete_shop_flash_sale")
		skippedMu.Unlock()
...
func Test_ShopFlashSale_DeleteShopFlashSaleItems(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.shop_flash_sale.delete_shop_flash_sale_items")
		skippedMu.Unlock()
