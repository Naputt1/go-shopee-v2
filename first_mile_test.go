...
func Test_FirstMile_GetUnbindOrderList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_unbind_order_list")
		skippedMu.Unlock()
...
func Test_FirstMile_GetDetail(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_detail")
		skippedMu.Unlock()
...
func Test_FirstMile_GenerateFirstMileTrackingNumber(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.generate_first_mile_tracking_number")
		skippedMu.Unlock()
...
func Test_FirstMile_BindFirstMileTrackingNumber(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.bind_first_mile_tracking_number")
		skippedMu.Unlock()
...
func Test_FirstMile_UnbindFirstMileTrackingNumber(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.unbind_first_mile_tracking_number")
		skippedMu.Unlock()
...
func Test_FirstMile_GetTrackingNumberList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_tracking_number_list")
		skippedMu.Unlock()
...
func Test_FirstMile_GetWaybill(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_waybill")
		skippedMu.Unlock()
...
func Test_FirstMile_GetChannelList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_channel_list")
		skippedMu.Unlock()
...
func Test_FirstMile_GetCourierDeliveryChannelList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_courier_delivery_channel_list")
		skippedMu.Unlock()
...
func Test_FirstMile_GetTransitWarehouseList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_transit_warehouse_list")
		skippedMu.Unlock()
...
func Test_FirstMile_GenerateAndBindFirstMileTrackingNumber(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.generate_and_bind_first_mile_tracking_number")
		skippedMu.Unlock()
...
func Test_FirstMile_BindCourierDeliveryFirstMileTrackingNumber(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.bind_courier_delivery_first_mile_tracking_number")
		skippedMu.Unlock()
...
func Test_FirstMile_UnbindFirstMileTrackingNumberAll(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.unbind_first_mile_tracking_number_all")
		skippedMu.Unlock()
...
func Test_FirstMile_GetCourierDeliveryDetail(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_courier_delivery_detail")
		skippedMu.Unlock()
...
func Test_FirstMile_GetCourierDeliveryWaybill(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_courier_delivery_waybill")
		skippedMu.Unlock()
...
func Test_FirstMile_GetCourierDeliveryTrackingNumberList(t *testing.T) {
	...
	if err != nil {
		skippedMu.Lock()
		skippedRoutes = append(skippedRoutes, "v2.first_mile.get_courier_delivery_tracking_number_list")
		skippedMu.Unlock()
